...
import com.project.millatinventory.controller.LoginController;

@Entity
@Table(name = "USERS")
public class Users extends BaseBean implements Serializable, HttpSessionBindingListener {
	...
	public String toString() {
		return "Users [id=" + id + ", loginId=" + loginId + ", userName=" + userName + ", password=" + password
				+ ", newPassword=" + newPassword + ", role=" + role + ", email=" + email + ", dateOfBirth="
				+ dateOfBirth + ", gender=" + gender + ", comments=" + comments + ", status=" + status + ", imageFile="
				+ imageFile + ", image=" + Arrays.toString(image) + ", department=" + department + "]";
	}
	...
	@Column(name="text",columnDefinition= "nvarchar2 (500)")
	private String text;
