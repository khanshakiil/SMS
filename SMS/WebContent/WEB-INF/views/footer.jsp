	<footer style="background-color:#34170f;">
    <div class="navbar navbar-inverse navbar-fixed-bottom" style="background-color:#34170f">
        <div class="container">
            <div class="navbar-collapse collapse" id="footer-body">
                <ul class="nav navbar-nav">
<!--                     <li><a href="#">Project Develope by &#169;Copywright Theme and Template</a></li>
 ...
 -->                    <li><a href="#">Terms &amp; Conditions</a></li>
                 ...
                 <ul class="nav navbar-nav" style="float: right;">
					<li><a href="#" style="">Version: v2.0</a></li>
                </ul>
            </div>
